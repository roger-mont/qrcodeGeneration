    ...
    return (
        ...
        backgroundImage: `url(${bannerKnow.src})`,
                ...
                <form className="flex gap-5">
                        ...
                        <PopoverTrigger asChild>
                            ...
                            >
                                ...
                                {date?.from ? (
                                    date.to ? (
                                        <>
                                            {format(date.from, "LL/MM/dd")} -{" "}
                                            {format(date.to, "LL/MM/dd")}
                                        </>
                                    ) : (
                                        format(date.from, "LL MM dd")
                                    )
                    ...
                    <Button className="bg-white text-[#004098]" type="button" onClick={() => handleSubmit()}>Enviar</Button>
                </form>
            </section>
        </div>
    )
