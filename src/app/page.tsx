...
export default function Home() {
  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen pt-8 pb-20 gap-16 font-[family-name:var(--font-geist-sans)]">
      <header className="flex flex-row w-80 p-5">
      ...
      <div className="w-full flex justify-center flex-col items-center bg-image-ocean" style={{
